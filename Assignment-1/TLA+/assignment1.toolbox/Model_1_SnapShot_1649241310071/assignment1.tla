...
PositionComputation == <>[](\A n \in DOMAIN NUMBER_OF_WORKERS : positions[n] = 1)
...
\* BEGIN TRANSLATION (chksum(pcal) = "730218cc" /\ chksum(tla) = "8bf7224b")
...
\* Last modified Wed Apr 06 12:34:53 CEST 2022 by angel
