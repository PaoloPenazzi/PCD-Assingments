...
LatchTermination == <>(latchNumber = 0)
BarrierTermination == <>(barrierNumber = 0)
end define;
...
\* BEGIN TRANSLATION (chksum(pcal) = "4c2b6952" /\ chksum(tla) = "3627cd9f")
VARIABLES iteration, velocities, positions, creation, barrierNumber, 
          latchNumber, pc
...
vars == << iteration, velocities, positions, creation, barrierNumber, 
           latchNumber, pc, myIteration >>
...
updateIteration == /\ pc[0] = "updateIteration"
                   ...
                   /\ UNCHANGED << velocities, positions, creation, 
                                   barrierNumber, latchNumber, myIteration >>
...
waitBarrier(self) == /\ pc[self] = "waitBarrier"
                     ...
                     /\ UNCHANGED << iteration, velocities, positions, 
                                     creation, barrierNumber, latchNumber, 
                                     myIteration >>
...
signalLatch(self) == /\ pc[self] = "signalLatch"
                     ...
                     /\ UNCHANGED << iteration, velocities, positions, 
                                     creation, barrierNumber, myIteration >>
...
\* Last modified Wed Apr 06 15:12:36 CEST 2022 by angel
